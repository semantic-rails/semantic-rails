    ...
    return [
        semantic_issue(
            ...
            message=(
                ...
                "a bucketed result, or to the window's size (e.g. 'quarter') "
                "for one total over it."
            ),
            severity="warning",
            stage="validate",
            details={
                ...
                "recovery_hints": [
                    {
                        "code": "SET_TIME_GRAIN",
                        "message": (
                            "Add time.grain to bucket the result; a grain the "
                            "size of [time.start, time.end) returns one total."
                        ),
