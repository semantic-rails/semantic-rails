...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "profile (semantic-rails profile init). With none of these, at a terminal, repl "
            "and bare semantic-rails open a home screen (open, create or import a project, or "
            "try the sample), and ask, ls and project status/validate offer the bundled "
            "jaffle_shop sample package (default No); noninteractive package reads stop "
