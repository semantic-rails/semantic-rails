...
def create_project(
    ...
    *,
    ...
    if overwrite:
        updates.extend(_retired_scaffold_model(project, root, files))
...
def _retired_scaffold_model(
    project: Path, workspace_root: Path, new_files: dict[str, bytes]
    ...
    if not ProjectTransaction(project, workspace_root=workspace_root).matches_creation_files(
