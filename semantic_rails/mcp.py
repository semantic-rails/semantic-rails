...
MCP_SERVER_INSTRUCTIONS = (
    ...
    "covers the window returns one total. The execute tool lists the expression shapes, "
    "including the variants Query IR composes at query time with no model change: any "
    "allowed aggregation of a measure, filtered aggregates, rolling windows, prior-period "
    "offsets, period-to-date, cumulative, ratios, conversion windows, scoped_aggregate, "
    "aggregate_if and metric_filters.\n"
    "\n"
