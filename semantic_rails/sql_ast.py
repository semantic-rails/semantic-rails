...
def build_filter_condition(expr: SqlExpr, op: Any, value: Any, *, path: str = "where") -> SqlExpr:
    ...
    return _single_value_comparison(expr, op, op_normalized, value, path=path)


def _single_value_comparison(
    expr: SqlExpr, op: Any, op_normalized: str, value: Any, *, path: str
) -> SqlExpr:
