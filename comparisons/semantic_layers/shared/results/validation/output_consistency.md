...
- Layer statuses: `semantic_rails=executed, metricflow=executed, cube=executed, malloy=executed, snowflake_semantic_views=native, ktx=executed`
...
- Layer statuses: `semantic_rails=executed, metricflow=executed, cube=executed, malloy=executed, snowflake_semantic_views=workaround, ktx=executed`
- Comparison status: `matched`
- Layers compared: `semantic_rails, metricflow, cube, malloy, ktx`
- Stale capture, not counted: `snowflake_semantic_views` matched
