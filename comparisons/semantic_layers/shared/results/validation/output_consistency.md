...
Generated at `2026-09-26T02:35:21+00:00` on dataset `4f24ad8276da`. Every layer is compared with the independent answer key in `shared/oracle/`.
...
- Layer statuses: `semantic_rails=executed, metricflow=executed, cube=executed, malloy=executed, snowflake_semantic_views=executed, ktx=executed`
- Comparison status: `matched`
- Layers compared: `semantic_rails, metricflow, cube, malloy, ktx`
- Stale capture, not counted: `snowflake_semantic_views` matched
